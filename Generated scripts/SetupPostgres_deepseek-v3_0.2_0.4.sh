...
# Allow connections from localhost to all databases for postgres user
...
echo "PostgreSQL setup complete. Database 'storedb' created, init.sql executed, and read-only user 'public_view' configured."